...
<!--
    ...
    <div class="container">
        <div class="card card-container">
			...
			<?=form_open("admin/account/login",array("class"=>"form-signin","method"=>"post"))?>
                
                <input type="text" id="inputEmail" name="username1" class="form-control" placeholder="username">
          ...
          <span style="color:red">  <?=$cserror?></span>
        </div><!-- /card-container -->
    </div><!-- /container -->
</html>	